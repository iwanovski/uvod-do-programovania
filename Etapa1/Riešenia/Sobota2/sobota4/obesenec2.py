...
while pocet_zivotov > 0 and not uhadol_si(slovo, hadane):
    ...
    # Kontrola pismena, ci sme uz nepouzili
    if pouzite_pismena.get(vstup) == True:
        print("Toto pismeno si uz skusal")
        continue

    # Pridaj pouzite pismeno do slovnika
    pouzite_pismena[vstup] = True
